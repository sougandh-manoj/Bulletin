-- Bulletin: make 48-hour news retention deterministic and visible to workers.
...
comment on function public.apply_news_retention(timestamptz, integer) is
  'Bounded 48-hour news cleanup invoked by ingestion; explicitly removes expired news relations before deleting clusters and articles.';
