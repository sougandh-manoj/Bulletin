...
export default function Terms() {
  return <div className={styles.page}>
    ...
    <main className={styles.main}>
      ...
      <p className={styles.notice}>These terms apply to participants aged 18 or older in Bulletin’s beta. By deliberately creating your briefing, you confirm that you are at least 18 and agree to these terms and the Privacy Policy.</p>
      ...
      <section className={styles.section}><h2>5. Eligibility and your responsibilities</h2><ul><li>be at least 18 years old when you create and use your Bulletin;</li><li>sign in with an enabled social account and provide accurate scheduling information;</li><li>keep your sign-in account and any owner-access links secure;</li><li>use Bulletin only for lawful, personal participation;</li><li>do not probe, disrupt, automate abuse of, reverse engineer, or bypass security and rate limits; and</li><li>do not use the service or summaries to infringe rights or misrepresent Bulletin or a publisher.</li></ul></section>
      <section className={styles.section}><h2>6. Email and account controls</h2><p>Bulletin currently uses Google sign-in through Supabase Auth for account access, with Apple sign-in planned. You may pause, resume, or confirm deletion through Manage briefing after signing in. Bulletin may pause delivery or invalidate access when necessary to protect the service, comply with law, respond to abuse, or address a security or reliability incident.</p></section>
